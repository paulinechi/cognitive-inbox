...
from ..models import Collection, CollectionModel, MemoModel, UserModel
...
def get_collections(
    ...
    """Get all collections"""
    collections = db.query(CollectionModel).filter(CollectionModel.user_id == current_user.id).all()
    return collections
...
def delete_collection(
    ...
    db.query(MemoModel).filter(
        MemoModel.memo_types.like(search_term),
