...
# Static prompt parts removed - prompts are now fully dynamic to include custom collections
# BASE_SYSTEM_PROMPT = [...]
...
def analyze_content(
    ...
    try:
        ...
        # Convert tags to string for prompt
        tags_instruction = (
            f"Assign strictly relevant tags from this allowed list only: {', '.join(available_tags)}. "
            "Do not invent new tags."
        ) if available_tags else "None"
